 ...
 *         &lt;element name="pedidoElegibilidade" type="{http://www.ans.gov.br/padroes/tiss/schemas}ct_elegibilidadeVerifica"/>
...
@XmlRootElement(name = "pedidoElegibilidadeWS")
public class PedidoElegibilidadeWS {

    @XmlElement(required = true)
    protected CabecalhoTransacao cabecalho;
    @XmlElement(required = true)
    protected CtElegibilidadeVerifica pedidoElegibilidade;
    @XmlElement(required = true)
    ...
    /**
     * Gets the value of the pedidoElegibilidade property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public CtElegibilidadeVerifica getPedidoElegibilidade() {
        return pedidoElegibilidade;
    }

    /**
     * Sets the value of the pedidoElegibilidade property.
     * 
     * @param value
     *     allowed object is
     *     {@link CtElegibilidadeVerifica }
     *     
     */
    public void setPedidoElegibilidade(CtElegibilidadeVerifica value) {
        this.pedidoElegibilidade = value;
    }
