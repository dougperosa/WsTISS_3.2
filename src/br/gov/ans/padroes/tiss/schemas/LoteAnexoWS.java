 ...
 *         &lt;element name="loteAnexo" type="{http://www.ans.gov.br/padroes/tiss/schemas}ct_anexoLote"/>
...
@XmlRootElement(name = "loteAnexoWS")
public class LoteAnexoWS {

    @XmlElement(required = true)
    protected CabecalhoTransacao cabecalho;
    @XmlElement(required = true)
    protected CtAnexoLote loteAnexo;
    @XmlElement(required = true)
     ...
     *     
     */
    public CtAnexoLote getLoteAnexo() {
        return loteAnexo;
    }
     ...
     *     
     */
    public void setLoteAnexo(CtAnexoLote value) {
