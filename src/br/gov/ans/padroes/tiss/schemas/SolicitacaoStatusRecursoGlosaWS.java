 ...
 *         &lt;element name="solicitacaoStatusProtocoloRecurso" type="{http://www.ans.gov.br/padroes/tiss/schemas}ct_protocoloSolicitacaoStatus"/>
...
@XmlRootElement(name = "solicitacaoStatusRecursoGlosaWS")
public class SolicitacaoStatusRecursoGlosaWS {

    @XmlElement(required = true)
    protected CabecalhoTransacao cabecalho;
    @XmlElement(required = true)
    protected CtProtocoloSolicitacaoStatus solicitacaoStatusProtocoloRecurso;
    @XmlElement(required = true)
    ...
    /**
     * Gets the value of the solicitacaoStatusProtocoloRecurso property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public CtProtocoloSolicitacaoStatus getSolicitacaoStatusProtocoloRecurso() {
        return solicitacaoStatusProtocoloRecurso;
    }

    /**
     * Sets the value of the solicitacaoStatusProtocoloRecurso property.
     * 
     * @param value
     *     allowed object is
     *     {@link CtProtocoloSolicitacaoStatus }
     *     
     */
    public void setSolicitacaoStatusProtocoloRecurso(CtProtocoloSolicitacaoStatus value) {
        this.solicitacaoStatusProtocoloRecurso = value;
    }
